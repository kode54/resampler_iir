...
inline static void iir_reset(iir * i, double cutoff, double quality, double gain)
{
    double v, k, q, n;
...
inline static void iir_clear(iir * i)
{
    i->z1 = 0.0;
    i->z2 = 0.0;
}

inline static double iir_process(iir * i, double in)
{
